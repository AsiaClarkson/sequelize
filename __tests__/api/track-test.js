...
it('should return a status of 200 when track is found', () => {
    return frisby('http://localhost:8000/api/tracks/5').expect('status', 200);
});

it('should return a status of 404 when track is not found', () => {
    return frisby('http://localhost:8000/api/tracks/-1').expect('status', 404);
});

it('should return the track name and its playlist', () => {
    return frisby('http://localhost:8000/api/tracks/5')
